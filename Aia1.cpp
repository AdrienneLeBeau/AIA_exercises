...
Mat Aia1::doSomethingThatMyTutorIsGonnaLike(Mat const& img){
	...
	// TO DO !!!
        Mat outputImage,outputImage1,outputImage2;
        //inRange(img,Scalar(10,10,100),Scalar(100,100,255),outputImage);
        cvtColor(img,outputImage,CV_BGR2GRAY);
        resize(outputImage,outputImage1,Size(700,300),0.3,0.5,CV_INTER_LINEAR);
        flip(outputImage1,outputImage2,-6);
	return outputImage2;
